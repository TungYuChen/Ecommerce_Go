...
type User struct {
	...
	Last_Name		*string					`json:"last_name" 	valudate:"required, min=2, max=30"`
...
type Prodcut struct { 
	...
	Iamge			*string					`json:"image"`
}

type ProductUser struct { 
	Product_ID		primitive.ObjectID		`bson:"_id"`
	Product_Name	*string					`josn:"product_name" bson:"product_name"`
	Price			int						`json:"price" bson:"price"`
	Rating			*uint					`json:"rating" bson:"rating"`
	Iamge			*string					`json:"image" bson:"image"`
}
